...
(52, 2, NULL, 9050, 56, 1, '2021-08-08', '2021-08-08', 3, 10, '海邊區 | 蒙古包 | 烤肉 | 露天電影', '', '2021-08-06 14:57:07', NULL),
...
(63, 2, 29, 450, 2, 1, '2021-08-09', NULL, 4, 98, '森林秘境探險', '', '2021-08-09 16:28:50', 'undefined'),
...
INSERT INTO `users` (`u_id`, `username`, `password`, `first_name`, `last_name`, `email`, `tel`, `gender`, `birthday`, `zip`, `address`, `invoice`, `points`, `role`, `created`, `visited`, `deg_1`, `deg_2`, `deg_3`) VALUES
(1, 'shipmaster', '1234', '孟竹', '李', 'dara@test.com', '0963251478', 2, '1994-06-17', 111001, '至善路二段221號', 'eGUI', NULL, 1, '2021-07-16 14:08:11', '2021-07-16 14:08:11', NULL, NULL, NULL),
(2, 'crew', '1234', '美琳', '林', 'crew@gmail.com', '0987654321', 2, '1976-12-07', 974042, '山嶺18號', 'B2C', 32, 1, '2021-07-16 14:08:11', '2021-08-08 17:19:09', 5, 5, 5);
...
--
ALTER TABLE `gallery`
  MODIFY `g_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `ordered`
  MODIFY `o_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
